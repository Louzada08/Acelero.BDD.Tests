using Acelero.BDD.Tests.Config;
using Acelero.BDD.Tests.Usuario;
using OpenQA.Selenium.Chrome;
using TechTalk.SpecFlow;
using Xunit;

namespace Acelero.BDD.Tests.Pedido
{
    [Binding]
    ...
    public class Pedido_AdicionarItemAoCarrinhoSteps
    {
        ...
        public void DadoOUsuarioEstejaLogado()
        {
            ...
            // Act 
            var login = true; //_loginUsuarioTela.Login(usuario);
        ...
        public void DadoQueUmProdutoEstejaNaVitrine()
        {
            ...
            browser.Navigate().GoToUrl("https://carros.dryve.com.br");
